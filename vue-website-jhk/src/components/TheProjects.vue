      ...
      fullstack: [
        {
          ...
          Die WebApp ist in Entwicklung. Der aktuelle Entwicklungsstand kann im dazugehörigen Git-Repository unter <a href='https://github.com/juhakun/propertyM' target='_blank' style='font-weight: bold; color:#29a329'>GitHub</a> angesehen werden.`,
...
The web app can then also be used to create annual invoices for extra costs for the tenants.
          ...
          The web app is under development. The current development status can be viewed in the associated Git repository at <a href='https://github.com/juhakun/propertyM' target='_blank' style='font-weight: bold; color:#29a329'>GitHub</a>.
...
Weitere Details zum Projekt sind bei <a href='https://github.com/juhakun/catch-the-balloons' target='_blank' style='font-weight: bold; color:#29a329'>GitHub</a> zu finden.`,
...
More details about the project can be found on <a href='https://github.com/juhakun/catch-the-balloons' target='_blank' style='font-weight: bold; color:#29a329'>GitHub</a>.`,
...
Weitere Details zum Projekt sind bei <a href='https://github.com/juhakun/muulti.de' target='_blank' style='font-weight: bold; color:#29a329'>GitHub</a> zu finden.`,
          ...
          More details about the project can be found on <a href='https://github.com/juhakun/muulti.de' target='_blank' style='font-weight: bold; color:#29a329'>GitHub</a>.`,
